...
public class AuthException extends RuntimeException {
	 ...
	 * @return
	 */
	public static AuthException create(String errorCode, String errorMessage) {
	...
	/**
	 * Creates an {@link AuthException} from a Map<String,String>.
	 * 
	 * @param errorParams
	 * @return
	 */
	public static AuthException valueOf(Map<String, String> errorParams) {
		...
		String errorMessage = errorParams.containsKey(DESCRIPTION) ? errorParams.get(DESCRIPTION)
				: null;
		AuthException ex = create(errorCode, errorMessage);
