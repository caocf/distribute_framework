...
public class InMemoryTokenStore implements TokenStore {
	...
	private final ConcurrentHashMap<String, AccessToken> authenticationToAccessTokenStore = new ConcurrentHashMap<String, AccessToken>();

	private final ConcurrentHashMap<String, Collection<AccessToken>> userNameToAccessTokenStore = new ConcurrentHashMap<String, Collection<AccessToken>>();

	private final ConcurrentHashMap<String, Collection<AccessToken>> clientIdToAccessTokenStore = new ConcurrentHashMap<String, Collection<AccessToken>>();

	private final ConcurrentHashMap<String, RefreshToken> refreshTokenStore = new ConcurrentHashMap<String, RefreshToken>();

	private final ConcurrentHashMap<String, String> accessTokenToRefreshTokenStore = new ConcurrentHashMap<String, String>();

	private final ConcurrentHashMap<String, Authentication> authenticationStore = new ConcurrentHashMap<String, Authentication>();

	private final ConcurrentHashMap<String, Authentication> refreshTokenAuthenticationStore = new ConcurrentHashMap<String, Authentication>();
	...
	private void addToCollection(ConcurrentHashMap<String, Collection<AccessToken>> store, String key,
			AccessToken token) {
