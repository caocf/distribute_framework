 ...
 * @author cruise.xu
 */
public class InHazelcastTokenStore implements TokenStore {
	...
	private BlockingQueue<TokenExpiry> expiryQueue = new DelayQueue<TokenExpiry>();
	...
	public void init() {
		...
		expiryMap = hazelcastInstance.getMap("expiryMap");
		
		expiryQueue = hazelcastInstance.getQueue("expiryQueue");
