...
$().ready(function() {
	...
	$inputForm.validate({
		rules: {
			"username": {
				required: true,
				remote: "check_username?oldUsername=${(USER.username)!}"
			},
			"realname": "required",
			"email": "email",
			"depart": "required"
	...
	<#list USER.rtsUserRoles as rtsUserRole>
		$("#userRole${rtsUserRole.rtsRole.id}").attr("checked","true");
	</#list>
	...
	<div class="con_search">
        ...
        <table class="add_list_table input tabContent">
            <tr>
                ...
                <td class="padT20"><input class="c_input_text text" type="text" name="username" value="${(USER.username)!}" maxlength="19"></td>
            </tr>
            <tr>
                <th class="padT20">真实姓名：</th>
                <td class="padT20"><input class="c_input_text text" type="text" name="realname" value="${(USER.realname)!}" maxlength="29"></td>
            </tr>
            <tr>
                <th class="padT20">密码：</th>
                <td class="padT20"><input class="c_input_text text" type="text" name="password" value="" maxlength="29">不填为不修改</td>
            </tr>
            <tr>
                <th class="padT20">手机：</th>
                <td class="padT20"><input class="c_input_text text" type="text" name="mobile" value="${(USER.mobile)!}" maxlength="64"></td>
            </tr>
            <tr>
